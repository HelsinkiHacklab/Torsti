...
#define E_STEPS_PER_MM   2.2   // NEMA 17 extruder 5mm diameter drive - empirically adjusted
...
#define FAST_XY_FEEDRATE 5500.0
#define FAST_Z_FEEDRATE  130.0
